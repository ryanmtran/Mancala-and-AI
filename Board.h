...
public:
	...
	private:
	int m_holes; //yields holes per side
	vector<int> north; //vector that holds all of north's holes with beans in them
	vector<int> south; //vector that holdls all of south's holes with beans in them
